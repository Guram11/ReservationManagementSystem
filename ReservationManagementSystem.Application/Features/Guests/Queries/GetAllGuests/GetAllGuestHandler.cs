...
public sealed class GetAllUserHandler : IRequestHandler<GetAllGuestsRequest, List<GuestResponse>>
{
    ...
    public async Task<List<GuestResponse>> Handle(GetAllGuestsRequest request, CancellationToken cancellationToken)
    {
