        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinCapacity = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationInvoices_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilityTimelines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvailabilityTimelines_RoomTypes_RoomTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RateRoomTypes", x => new { x.RateId, x.RoomTypeId });
                    table.ForeignKey(
                        name: "FK_RateRoomTypes_Rates_RateId",
                        column: x => x.RateId,
                        principalTable: "Rates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RateRoomTypes_RoomTypes_RoomTypeId",
                        column: x => x.RoomTypeId,
                        principalTable: "RoomTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RateTimelines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RateTimelines_RateRoomTypes_RateId_RoomTypeId",
                        columns: x => new { x.RateId, x.RoomTypeId },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationRoomPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationRoomPayments_ReservationRooms_ReservationRoomId",
                        column: x => x.ReservationRoomId,
                        principalTable: "ReservationRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationRoomServices", x => new { x.HotelServiceId, x.ReservationRoomId });
                    table.ForeignKey(
                        name: "FK_ReservationRoomServices_HotelServices_HotelServiceId",
                        column: x => x.HotelServiceId,
                        principalTable: "HotelServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReservationRoomServices_ReservationRooms_ReservationRoomId",
                        column: x => x.ReservationRoomId,
                        principalTable: "ReservationRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationRoomTimelines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationRoomTimelines_ReservationRooms_ReservationRoomId",
                        column: x => x.ReservationRoomId,
                        principalTable: "ReservationRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityTimelines_RoomTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RateRoomTypes_RoomTypeId",
                table: "RateRoomTypes",
                column: "RoomTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationInvoices_ReservationId",
                table: "ReservationInvoices",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationRoomPayments_ReservationRoomId",
                table: "ReservationRoomPayments",
                column: "ReservationRoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationRoomServices_ReservationRoomId",
                table: "ReservationRoomServices",
                column: "ReservationRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationRoomTimelines_ReservationRoomId",
