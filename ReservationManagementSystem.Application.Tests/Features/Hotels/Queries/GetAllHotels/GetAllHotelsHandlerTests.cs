...
namespace ReservationManagementSystem.Application.Tests.Features.Hotels.Queries.GetAllHotels;
...
public class GetAllHotelsHandlerTests
{
    ...
    [Fact]
    public async Task Handle_Should_Return_List_Of_HotelResponses()
    {
        // Arrange
