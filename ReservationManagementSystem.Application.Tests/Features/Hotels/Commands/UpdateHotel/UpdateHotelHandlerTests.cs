...
namespace ReservationManagementSystem.Application.Tests.Features.Hotels.Commands.UpdateHotel;
...
public class UpdateHotelHandlerTests
{
    ...
    [Fact]
    public async Task Handle_Should_Return_Success_When_Hotel_Is_Updated()
    {
        // Arrange
