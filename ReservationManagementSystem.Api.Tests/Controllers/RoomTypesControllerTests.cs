...
public class RoomTypesControllerTests
{
    ...
    public async Task Get_WhenCalled_ReturnsOkResultWithRoomTypeResponse()
    {
        ...
        // Act
        var actionResult = await _controller.Get(roomTypeId, CancellationToken.None);
    ...
    public async Task Create_WhenCalled_ReturnsOkResultWithRoomTypeResponse()
    {
        ...
        // Act
        var actionResult = await _controller.Create(createRoomTypeRequest, CancellationToken.None);
    ...
    public async Task Update_WhenCalled_ReturnsOkResultWithRoomTypeResponse()
    {
        ...
        // Act
        var actionResult = await _controller.Update(updateRoomTypeRequest, CancellationToken.None);
    ...
    public async Task Delete_WhenCalled_ReturnsOkResultWithRoomTypeResponse()
    {
        ...
        // Act
        var actionResult = await _controller.Delete(roomTypeId, CancellationToken.None);
